...
class RequestNotFound extends HttpException {
    /**
    ...
    constructor(status?: number, errorCode?: number, message?: string, devMessage?: string) {
        ...
        const responseMessage: string = message || i18n.t('requestNotFoundError');
        const responseDevMessage: string = devMessage || 'Request not found';
